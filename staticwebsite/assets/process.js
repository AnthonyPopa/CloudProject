...
const PHOTOGALLERY_S3_BUCKET_URL = "photobucket-popa-2022-4150";
...
function deletePhoto(PhotoID){
    $.ajax({
        ...
        success: function(response) {                        
            ...
            var url = response.body.Item.URL;
            var fileNameSplit = url.split("photos/");
            removePhoto(fileNameSplit[1]);
        },
        error: function() {
            console.log("Failed");
        }
